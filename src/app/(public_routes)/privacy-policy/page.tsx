            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  At Pawtful ("we," "our," or "us"), we are committed to protecting your privacy and
                  ...
                  website, use our mobile application, or purchase our products and services.
                </p>
              ...
              <div className="mb-12">
                ...
                <h3 className="text-2xl font-semibold text-[#028391] mb-4">
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  <li>
                    <strong>Providing Services:</strong> To process orders, deliver products, and
                    provide customer support
                  </li>
                  <li>
                    <strong>Personalization:</strong> To create personalized meal plans and
                    recommendations for your pet
                  </li>
                  <li>
                    <strong>Communication:</strong> To send order confirmations, shipping updates,
                    and respond to inquiries
                  </li>
                  <li>
                    <strong>Marketing:</strong> To send promotional offers, newsletters, and product
                    updates (with your consent)
                  </li>
                  <li>
                    <strong>Improvement:</strong> To analyze usage patterns and improve our products
                    and services
                  </li>
                  <li>
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  <li>
                    ...
                    us in operating our business (payment processors, shipping partners, IT
                    services)
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Safety and Security:</strong> To protect our rights, property, or
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <li>
                    <strong>Restriction:</strong> Request limitation of how we process your
                    information
                  </li>
                  <li>
              ...
              <div className="bg-[#C4DEE1] rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  ...
                  to us. Your trust is essential to our mission of providing the best nutrition for
                  your beloved pets.
                </p>
              </div>
            </div>
