            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  between you and Pawtful ("we," "our," or "us") regarding your use of our website,
                  mobile application, products, and services (collectively, the "Services").
                </p>
                <p className="text-gray-700 leading-relaxed">
                  By accessing or using our Services, you agree to be bound by these Terms. If you
                  do not agree to these Terms, please do not use our Services. We reserve the right
                  to modify these Terms at any time, and such modifications will be effective
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  <li>
                    Customized meal plans for dogs based on breed, age, weight, and health
                    conditions
                  </li>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Our Services are designed to provide high-quality nutrition for your pets, but
                  they are not intended to replace professional veterinary care.
                </p>
              </div>

              <div className="mb-12">
                <h2 className="text-3xl font-bold text-[#028391] mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  You must be at least 18 years old to create an account and use our Services. If
                  you are under 18, you may only use our Services with the involvement and consent
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  However, we do not warrant that product descriptions, pricing, or other content is
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  order placement. We accept various payment methods as indicated on our website.
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  <strong>Important:</strong> Our products and services are not intended to
                  diagnose, treat, cure, or prevent any disease or health condition. You acknowledge
                  and agree that:
                </p>
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  <li>Our nutritional advice is for informational purposes only</li>
                  <li>
                    You should consult with a veterinarian before making significant dietary changes
                  </li>
                  <li>We are not responsible for any adverse reactions or health issues</li>
                  <li>Individual results may vary</li>
                  <li>
                    You should monitor your pet's health and discontinue use if problems occur
                  </li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
                  If your pet experiences any adverse reactions, discontinue use immediately and
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  All content on our website and mobile application, including but not limited to
                  text, graphics, logos, images, and software, is the property of Pawtful or its
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  To the maximum extent permitted by law, Pawtful shall not be liable for any
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  our Services shall not exceed the amount you paid to us in the 12 months preceding
                  the claim.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed">
                  You agree to indemnify, defend, and hold harmless Pawtful and its officers,
                  directors, employees, and agents from and against any claims, damages, losses,
                  costs, and expenses (including reasonable attorneys' fees) arising from your use
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  resolved through binding arbitration in San Francisco, California, in accordance
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed">
                  These Terms constitute the entire agreement between you and Pawtful regarding your
                  use of our Services and supersede all prior agreements and understandings, whether
                  written or oral.
                </p>
              </div>
              ...
              <div className="bg-[#C4DEE1] rounded-lg p-6">
                <h3 className="text-xl font-bold text-[#028391] mb-4">
                  Thank You for Choosing Pawtful
                </h3>
                <p className="text-gray-700">
                  We appreciate your trust in us to provide the best nutrition for your beloved
                  pets. These terms help ensure a safe, reliable, and enjoyable experience for all
                  our customers. If you have any questions or concerns, please don't hesitate to
