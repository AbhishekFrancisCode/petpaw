...
export const productDetails1: ProductDetailsProps[] = [
  ...
  },
  {
    ...
    ingredients: [
      "Soya Chunks",
      "White Rice (medium/long grain)",
      "Coriander/Green Peas/Mint",
      "Coconut Oil",
      "Sweet Potatoes/White Potatoes",
      "Pumpkin",
      "Flaxseed Powder"
  ...
  },
  {
    ...
    ingredients: [
      "Paneer",
      "White/Brown Rice (medium/long grain)",
      "Coriander/Mint",
      "Coconut Oil",
      "Bottle Gourd",
      "Carrots",
