...
export default function NewsLetter() {
  ...
  return (
    <section className="flex relative place-content-center py-14 px-2 lg:px-8 bg-[#FFF8EF]">
      <div className="sb-container bg-transprent px-8 flex flex-col lg:flex-row gap-0 justify-between items-center rounded-lg pt-8 lg:pt-14 pb-16 lg:pb-14 border-2 border-[#EE9422]">
