...
export default function Section_type_6() {
  return (
    <div className="place-content-center bg-[#FFF8EF]">
      <div className="mx-auto min-h-[800px] grid grid-rows-10 grid-cols-1 lg:grid-rows-1 lg:grid-cols-10">
        <div className="order-2 lg:order-1 flex flex-col row-span-6 lg:col-span-6 bg-[#C4DEE1] lg:p-20">
          ...
          <div className="flex-1 place-content-center lg:place-content-start lg:px-10 xl:px-12 py-4 w-[550px]">
          ...
          <div className="flex place-content-center lg:place-content-end">
            <Button
              ...
              handleRedirect={() => {}}
              cls="bg-[#028391] w-[300px] lg:h-16 rounded-full "
            />
          </div>
        </div>
