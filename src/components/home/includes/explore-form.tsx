      ...
      >
        <div className="flex max-h-12">
          <input
            ...
            className="w-[292px] h-12 bg-transparent rounded-xl rounded-br-md border focus:ring-0 focus:border-none"
          />
        </div>
        <button
          type="submit"
          className="flex w-[224px] lg:w-[172px] h-12 rounded-xl place-content-center items-center gap-4 bg-[#EE9422]"
        >
