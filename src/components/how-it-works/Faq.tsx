...
//       answer: "Our ingredients are sourced from trusted suppliers with a focus on quality and sustainability.",
//     },
//     {
...
//       answer: "Our packaging is designed to keep the food fresh for several hours, even if you're not home.",
//     },
//     {
...
//   return (
//     <div className="bg-orange-100 p-6 rounded-md shadow-md max-w-3xl mx-auto">
//       <h1 className="text-2xl font-bold text-center mb-6">Frequently Asked Questions</h1>
//       <div className="space-y-4">
//         {faqs.map((faq, index) => (
//           <div key={index} className="border rounded-md overflow-hidden">
//             <button
//               className="w-full flex justify-between items-center p-4 bg-white text-left text-lg font-semibold hover:bg-gray-100"
...
//                 openIndex === index ? "max-h-screen opacity-100 p-4 bg-gray-50" : "max-h-0 opacity-0"
//               }`}
//             >
