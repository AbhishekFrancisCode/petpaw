...
export default function Footer({ _isBlack, _isMargin }: any) {
  ...
  return (
    <div
      className={`bg-[#F5F5F5] pt-4 pb-10 md:px-28 ${_isBlack ? "bg-black" : "bg-[#F5F5F5]"} ${_isMargin ? "mb-24 lg:mb-0" : ""}`}
    >
        ...
        <div className="lg:max-w-[100%]  sm:px-2 md:p-0 flex flex-col justify-between">
          <div className="flex flex-col">
            <div className="text-[#000000] text-sm opacity-70 mb-4 leading-7">
              <Link href="">About Us</Link> |<Link href=""> Contact Us</Link> |<Link href=""> Privacy Policy</Link> |
              <Link href=""> Terms and Conditions</Link>
            </div>
          </div>
        </div>
          <div className="text-[#000000] opacity-70 text-[11px]">
            Gina. &copy; 2024. All Rights Reserved
          </div>
        </div>
      </div>
    </div>
