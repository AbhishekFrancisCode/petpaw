...
//           </div>
//         </div>
//         <div className="order-2 p-0  row-span-3 lg:col-span-3 py-4">
//           <div className=" flex w-full place-content-center lg:place-content-end px-2 lg:px-6">
//             {/* <Swiper
...
//                   <div className="w-full h-[400px] md:w-[350px] md:h-[350px] lg:w-[450px] lg:h-[400px] xl:w-[600px] xl:h-[450px] rounded-xl border-[#999999] border-2 relative flex">
//                     <Image
//                       key={index}
//                       src={slide.src}
//                       alt={""}
...
//                 </div>
//                 <div className="w-full h-[400px] lg:w-[450px] xl:w-[750px] xl:h-[550px] relative flex mt-8">
//                   <Image
